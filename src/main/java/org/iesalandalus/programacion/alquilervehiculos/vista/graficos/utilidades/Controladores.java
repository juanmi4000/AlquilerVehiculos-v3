...
public class Controladores {
	...
	private static final Map<String, Controlador> mControladores = new HashMap<>();

	private Controladores() {
	}

	public static Controlador get(String vistaFxml, String titulo, Stage propietario) {
		return mControladores.getOrDefault(vistaFxml, crear(vistaFxml, titulo, propietario));
	}
	...
	private static Controlador crear(String vistaFxml, String titulo, Stage propietario) {
		...
		try {
			...
			mControladores.put(vistaFxml, controlador);
		} catch (IOException e) {
